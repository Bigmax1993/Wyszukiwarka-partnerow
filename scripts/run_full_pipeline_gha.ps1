...
if ($DiscoveryRunId) {
    Write-Host ""
    Write-Host "=== GU piatek discovery (juz trwa: $DiscoveryRunId) ===" -ForegroundColor Cyan
    Wait-GhaRun -Name "GU piatek discovery" -RunId $DiscoveryRunId -ContinueOnDiscoveryArtifact
