# -*- coding: utf-8 -*-
"""Testy jednostkowe: referencje marketów na stronie www."""
...
class TestRetailReferenceEvidence:
    ...
    def test_chain_markers_detected_in_text(self):
        text = "Neubau Aldi Süd Filiale und Penny Markt."
        low = text.lower()
    ...
    def test_portfolio_negates_non_retail(self):
        text = "Portfolio: Wohnungsbau, Bürogebäude, Hallenbau — keine Einzelhandelsprojekte."
