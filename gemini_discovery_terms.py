...
def build_gemini_discovery_prompt(
    ...
    *,
    ...
    return (
        ...
        f"{templates}\n\n"
        "STRICT:\n"
        f"- Jede Zeile MUSS eines enthalten: {', '.join(gu_required_keywords_sample(6))}\n"
        f"- Retail-Kontext erwünscht: {', '.join(retail_context_keywords_sample(8))}\n"
        f"- NICHT: {', '.join(negative_keywords_sample(8))}\n"
